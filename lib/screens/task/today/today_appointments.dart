    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Gap(20),
          if (widget.appointmentDocuments.isEmpty) ...{
            const Column(
              children: [
                EmptyScreen(
                  isAddButton: false,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      SizedBox(
                                          width: context.width * 0.7, child: Text(appointment['type_desc'] ?? appointmentList[index].description)),
                                      const Gap(10),
                                      Row(
                                        children: [
                                          AppImage.assets(
