...
import 'package:aivi/core/extensions/e_to_dateTime.dart';
  ...
  Future<void> fetchData() async {
    try {
      ...
      if (snapshot.exists) {
        ...
        setState(() {
          // Perform other actions with data
        ...
        setState(() {
          type.text = ''; // or some default value
          description.text = ''; // or some default value
        });
