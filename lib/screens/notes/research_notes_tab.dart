...
class ResearchNotesTab extends StatefulWidget {
  final AsyncSnapshot<QuerySnapshot<Object?>> snapshot;
  const ResearchNotesTab({super.key, required this.snapshot});

  @override
  State<ResearchNotesTab> createState() => _ResearchNotesTabState();
}
...
class _ResearchNotesTabState extends State<ResearchNotesTab> {
  ...
  void initState() {
    ...
    for (var document in documents) {
      ...
      if (userId == currentUserId &&  type == "Research") {
