    ...
    return Container(
      ...
      child: Padding(
        ...
        child: MasonryGridView.count(
          crossAxisCount: 2,
          itemCount: notesItemsList.length + 1,
          mainAxisSpacing: 10,
          crossAxisSpacing: 10,
          itemBuilder: (context, index) {
            ...
            return InkWell(
              onTap: (){
                context.push(AppRoute.notesDetails);
              },
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      notesItemsList[assetIndex].title,
